CREATE TABLE [dbo].[tblStoreTransferItemDetails](
	...
	[ReceiveBillQTYStatus] [bit] NOT NULL CONSTRAINT [DF_tblStoreTransferItemDetails_ReceiveBillQTYStatus]  DEFAULT ((0)),
	[CreatedOn] [datetime] NOT NULL CONSTRAINT [DF_tblStoreTransferItemDetails_CreatedOn]  DEFAULT (getdate()),
