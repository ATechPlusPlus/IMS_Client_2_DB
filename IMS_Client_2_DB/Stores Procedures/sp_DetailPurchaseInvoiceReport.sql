...
BEGIN
	...
	BillDate,(CASE WHEN p1.IsInvoiceDone =1 THEN 'Posted' WHEN p1.IsInvoiceDone =0 THEN 'Not Posted' END) IsInvoiceDone,TotalQTY,BillValue,Discount,ForeignExp,GrandTotal,LocalValue,LocalExp,LocalValue
